...
if xmessage -timeout 10 -buttons Abort:1 -center "VisuTest succesfully updated, restarting in 10 seconds. Click 'Abort' to abort restart."; then
    shutdown -r now
else
    echo "Restart aborted by user, no problem." >> $LOGFILE
fi
