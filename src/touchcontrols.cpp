  ...
  : target(target)
{
  ...
  if(numeric) {
    ...
    zeroButton->setMinimumHeight(50);
    ...
    threeButton->setMinimumHeight(50);
    ...
    fourButton->setMinimumHeight(50);
    ...
    fiveButton->setMinimumHeight(50);
    ...
    sevenButton->setMinimumHeight(50);
    ...
    eightButton->setMinimumHeight(50);
    ...
    nineButton->setMinimumHeight(50);
